<template>
    <div>
        ...
        <model-table :storeStatus="status" :currentPage="$store.state.app.user_page_info.currentPage" :totalPage="$store.state.app.user_page_info.totalPage">
        </model-table>
...
<script>
import modelTable from "./model_ip_table.vue";
import modelPage from "@/views/public-components/changePage";
