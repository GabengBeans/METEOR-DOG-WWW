<template>
  <div id='user_table' class="table">
    <Table style="min-width:800px;margin:0 16px;" border stripe :columns="columns" :data="$store.state.app.order_demand_search_result">
    </Table>
              ...
              h(
                "Button",
                {
                  ...
                  on: {
                    click: () => {
                      this.$router.push(
                        "/order-demand-detail/" + params.row.id
                      );
                    }
                  }
                },
              ...
              h(
                "Button",
                {
                  ...
                  on: {
                    click: () => {
                      this.$router.push(
                        "/order-demand-drawback/" + params.row.id
                      );
                    }
                  }
                },
