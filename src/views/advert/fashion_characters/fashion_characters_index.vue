<template>
    <div>
        ...
        <quality-page :storeStatus="status" :currentPage="$store.state.app.fashion_characters_page_info.currentPage" :totalPage="$store.state.app.fashion_characters_page_info.totalPage"></quality-page>
...
<script>
import qualityTable from "./fashion_characters_table.vue";
        ...
        .then(resp => {
          if (resp.data.success) {
            this.$store.commit("GET_FASHION_CHARACTERS_LIST", {
                ...
                pageNo: this.$store.state.app.fashion_characters_public_page
            });
            this.$Message.destroy();
