...
<script>
  ...
  export default {
    ...
    created(){
      console.log(this.$store.state.app.group_bind_search_info)
      this.$store.commit("GET_GROUP_BIND_INFO",{data:this.$store.state.app.group_bind_search_info,pageNo:1})
    }
  }
</script>
<style lang="less">
