<template>
    <div>
        ...
        <quality-page :storeStatus="status" :currentPage="$store.state.app.model_ip_page_info.currentPage" :totalPage="$store.state.app.model_ip_page_info.totalPage"></quality-page>
...
<script>
import qualityTable from "./model_ip_table.vue";
